...
let earth_revolution_speed = 2.9
let mars_revolution_speed = 2.4
let jupiter_revolution_speed = 2.7
let saturn_revolution_speed = 0.9
let uranus_revolution_speed = 0.6
